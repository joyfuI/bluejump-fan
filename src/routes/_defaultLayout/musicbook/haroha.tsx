  ...
  return (
    <>
      <p>
        ...
        <a
          href="https://docs.google.com/spreadsheets/d/1Fi7NN3XbpeVqqH-nQ2VTN9np8YYurcetsj_z_RZc0Q8/edit?usp=sharing"
          rel="noreferrer"
          target="_blank"
        >
          원본 노래책
...
export const Route = createFileRoute('/_defaultLayout/musicbook/haroha')({
  staticData: { musicbook: 'haroha' },

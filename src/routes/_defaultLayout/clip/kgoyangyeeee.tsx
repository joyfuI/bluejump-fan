...
const RouteComponent = () => {
  ...
  return (
    <>
      <Alert
        className="mb-6"
        title="제목에 눙지가 포함된 클립 목록입니다. 누눙지 방송국 클립은 제외합니다. 최근 1개월까지만 검색합니다."
        type="info"
      />
      <Flex gap="small" wrap>
        {data?.flat().map((item) => (
...
export const Route = createFileRoute('/_defaultLayout/clip/kgoyangyeeee')({
  staticData: { clip: 'kgoyangyeeee' },
